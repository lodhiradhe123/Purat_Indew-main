  ...
  const menuItems = [
    {
      ...
      icon: faHistory,
      route: "/dashboard/ManageClients/Clients",
      onClick: () => navigate("/dashboard/ManageClients/Clients"),
    },
    {
      name: "ScheduledBroadcasts",
      icon: faCalendarAlt,
      route: "/dashboard/voice/scheduledbroadcasts",
      onClick: () => navigate("/dashboard/voice/scheduledbroadcasts"),
    },
    {
