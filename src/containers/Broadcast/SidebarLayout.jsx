...
const SidebarLayout = () => {
  ...
  const menuItems = [
    { name: "BroadcastHistory", icon: faHistory, route: "/dashboard/whatsapp/broadcast", onClick: () => navigate("/dashboard/whatsapp/broadcast") },
    { name: "ScheduledBroadcasts", icon: faCalendarAlt, route: "/dashboard/whatsapp/scheduledbroadcasts", onClick: () => navigate("/dashboard/whatsapp/scheduledbroadcasts") },
    { name: "TemplateMessages", icon: faEnvelope, route: "/dashboard/whatsapp/templates", onClick: () => navigate("/dashboard/whatsapp/templates") },
  ];
