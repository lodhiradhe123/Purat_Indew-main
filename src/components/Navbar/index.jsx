...
const MENU_ITEMS = [
  { name: "Team Inbox", icon: "inbox", path: "/dashboard/whatsapp/teamInbox" },
  { name: "Broadcast", icon: "broadcast-tower", path: "/dashboard/whatsapp/broadcast" },
  { name: "Chatbots", icon: "robot", path: "/dashboard/whatsapp/chatbots" },
  { name: "CRM", icon: "address-book", path: "/dashboard/whatsapp/crm" },
  { name: "Contacts", icon: "address-book", path: "/dashboard/whatsapp/contacts" },
  { name: "Automations", icon: "cogs", path: "/dashboard/whatsapp/automations" },
];

const DROPDOWN_ITEMS = [
  { name: "Analytics", icon: "chart-bar", path: "/dashboard/whatsapp/analytics" },
  { name: "API docs", icon: "code", path: "/dashboard/whatsapp/api-docs" },
  { name: "User Management", icon: "users", path: "/dashboard/whatsapp/user-management" },
  { name: "Integration", icon: "plug", path: "/dashboard/whatsapp/integration" },
  { name: "Web Hooks", icon: "exchange-alt", path: "/dashboard/whatsapp/webhooks" },
  { name: "Commerce", icon: "shopping-cart", path: "/dashboard/whatsapp/commerce" },
];
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="text-lg font-medium text-gray-600 hover:text-blue-500"
                >
            ...
            >
              <div className="p-6">
                ...
                <div className="mb-6 text-center">
                  ...
                  />
                  <h3 className="mt-2 text-xl font-semibold text-gray-900">{user?.username}</h3>
